...
class MercadolivreSpider(scrapy.Spider):
    name = "mercadolivre"
    start_urls = ["https://lista.mercadolivre.com.br/ps5"]
    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            yield {
                ...
                'by': product.css('p.ui-search-official-store-label.ui-search-item__group__element.ui-search-color--GRAY::text').get(),
                ...
                'reviews_number': product.css('span.ui-search-reviews__rating-number::text').get(),
            }
